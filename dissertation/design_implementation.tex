...
\begin{figure}[h!]
	\centering
	\includegraphics[height=0.4\textheight]{images/demo_blender.png}
...
\begin{figure}[h!]
	\centering
	\includesvg[height=0.4\textheight]{images/demo_result.svg}
...
There are no specific performance requirements, however some basic run-times figures are presented here.
Run-time does not include time taken for Cycles to produce a render result, performance analysis is limited only to the developed System (i.e. processing of render passes to produce the final SVG).