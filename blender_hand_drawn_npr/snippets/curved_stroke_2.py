...
construction_curve = fitpath(coords, 3)
...
for point in points:
    circle = drawing.circle(center=(point[0], point[1]), r=0.2, fill='red', stroke_width=0)
    drawing.add(circle)

for coord in coords:
    circle = drawing.circle(center=(coord[0], coord[1]), r=0.1, fill='blue', stroke_width=0)
    drawing.add(circle)
